...
running_number = int(input("Enter the Running number"))

section_B = section_B[section_B['Running_number'] != running_number]
section_C = section_C[section_C['Running_number'] != running_number]
section_D = section_D[section_D['Running_number'] != running_number]
section_E = section_E[section_E['Running_number'] != running_number]
section_F = section_F[section_F['Running_number'] != running_number]
section_G = section_G[section_G['Running_number'] != running_number]
section_H = section_H[section_H['Running_number'] != running_number]
section_I = section_I[section_I['Running_number'] != running_number]
section_J = section_J[section_J['Running_number'] != running_number]
section_K = section_K[section_K['Running_number'] != running_number]
section_L = section_L[section_L['Running_number'] != running_number]
section_M = section_M[section_M['Running_number'] != running_number]

for num in section_A['Running_number']:
    if num == running_number:
        section_A = section_A[section_A['Running_number'] != running_number]
        print(section_A)
